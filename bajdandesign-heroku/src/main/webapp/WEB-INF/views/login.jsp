...
<html lang="en">
    ...
    <body class="background_red" onclick="backgroundClicked()">
		<div class="div_blue">
        	<img src="../here.jpg">        
		</div>
    </body>
...
<html lang="en">
    <head>
        ...
        <link href="js/dist/lightgallery/css/lightgallery.css" rel="stylesheet">
        <style type="text/css">
            body{
    ...
    <body class="home">
        ...
        <script src="js/dist/lightgallery/js/lightgallery-all.min.js"></script>
